...
<html lang="es">
	<head>
		...
		<title>La tecnología: dispositivos, características, etc.</title>
...
<!-- FIN GOOGLE COMPLEMENTS -->
	...
	<body>
       ...
       <div class="all-body-all">        
		...
		<section>
           <div class="itinery">
                <a href="../../index.php">Inicio </a><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="../informacioncentral.php"> Informaciones </a><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="https://www.smailbook.com/templates/informaciones/technology.php"> Tecnología | Toda información relativa </a>
            </div>
            
            <div class="containerinfocentral">
                <p style="font-size: 35px; text-align: center; padding-bottom: 7px;"><strong>Todo sobre la tecnología actual</strong></p>
                <hr>
                <br/>
                <div id="slider">
            <ul>
                <li><img src="../../img/imginternas/technology/slider.jpg" alt="Tech-pic"></li>
                <li><img src="../../img/imginternas/technology/slider1.jpg" alt="Tech-pic"></li>
                <li><img src="../../img/imginternas/technology/slider2.jpg" alt="Tech-pic"></li>
                <li><img src="../../img/imginternas/technology/slider3.jpg" alt="Tech-pic"></li>
            </ul>
            </div>
