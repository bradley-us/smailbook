...
<html lang="es">
	<head>
		...
		<title>Desarrollo y Programación Web</title>
...
<!-- FIN GOOGLE COMPLEMENTS -->
	...
	<body>
       ...
       <div class="all-body-all">        
		...
		<section>
           <div class="itinery">
                <a href="../../index.php">Inicio </a><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="../informacioncentral.php"> Informaciones </a><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="https://www.smailbook.com/templates/informaciones/developer.php"> Desarrollo y Programación Web </a>
            </div>
            
            <div class="containerinfocentral">
                <p style="font-size: 35px; text-align: center; padding-bottom: 7px;"><strong>Próximamente</strong></p>
                <hr>
                <br/>
                <div id="slider">
            <ul>
                <li><img src="../../img/imginternas/developer/slider.png" alt="Dev-pic"></li>
                <li><img src="../../img/imginternas/developer/slider1.jpg" alt="Dev-pic"></li>
                <li><img src="../../img/imginternas/developer/slider2.jpg" alt="Dev-pic"></li>
                <li><img src="../../img/imginternas/developer/slider3.jpg" alt="Dev-pic"></li>
            </ul>
            <h1>¡Infórmate de lo último!<br/>
                Acércate al conocimiento<br/>Visita nuestros foros!</h1>
            </div>

                    <div class="w1-all-items">
                      
                      <ul id="accordion-box" class="accordion-box">
                           <li>
                               <div class="link-box"><i class="fa fa-tv" aria-hidden="true"></i>... <i class="fa fa-chevron-down" aria-hidden="true"></i></div>
                                   <ul class="submenu-accordion-from-body-section-box">
                                       <div class="box-submenu-accordion">
                                           <h3></h3>
                                           <p></p>
                                       </div>
                                    </ul>
                    ...
                    <br/>
                        ...
                        <ul id="accordion" class="accordion">
                           <li>
                               <div class="link"><i class="fa fa-paint-brush" aria-hidden="true"></i>... <i class="fa fa-chevron-down" aria-hidden="true"></i></div>
                                   <ul class="submenu-accordion-from-body-section">
                                       <li><a href="">...</a></li>
                                       <li><a href="">...</a></li>
                                       <li><a href="">...</a></li>
                                       <li><a href="">...</a></li>
