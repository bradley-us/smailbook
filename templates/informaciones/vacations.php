...
<!-- FIN GOOGLE COMPLEMENTS -->
	...
	<body>
       ...
       <div class="all-body-all">        
		...
		<section>
           <div class="itinery">
                <a href="../../index.php">Inicio </a><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="../informacioncentral.php"> Informaciones </a><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="https://www.smailbook.com/templates/informaciones/vacations.php"> Vacaciones </a>
            </div>
            
            <div class="containerinfocentral">
                <p style="font-size: 35px; text-align: center; padding-bottom: 7px;"><strong>Vacaciones</strong></p>
                <hr>
                <br/>
                <div id="slider">
            <ul>
                <li><img src="../../img/imginternas/vacations/slider.jpg" alt="Vac-pic"></li>
                <li><img src="../../img/imginternas/vacations/slider1.jpg" alt="Vac-pic"></li>
                <li><img src="../../img/imginternas/vacations/slider2.jpg" alt="Vac-pic"></li>
                <li><img src="../../img/imginternas/vacations/slider3.jpg" alt="Vac-pic"></li>
            </ul>
